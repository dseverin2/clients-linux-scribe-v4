...
#wget -nc --no-check-certificate https://codeload.github.com/dane-lyon/Esubuntu/zip/master #(pose problème lors des tests)
...
wget -nc http://nux87.free.fr/pour_script_integrdom/Esubuntu-master.zip
...
wget -nc http://nux87.free.fr/esu_ubuntu/wallpaper.zip
